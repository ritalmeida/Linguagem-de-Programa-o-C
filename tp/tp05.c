...
//  lp1_ufp
//
//  Created by Rita Vieira Almeida on 12/10/2020.
...
int main_tp05(int argc, const char * argv[]){
    ...
    //printf("Indice da primeira vogal: %d \n", index_first_vogal(str));
    
    //printf("%s \n", replace_char_by_char(str, 'm', 'n'));
    
    //printf("%s \n", remove_blanks(str));
   
    //printf("%s \n", remove_chars(str, sub));
